      ...
      <Modal isOpen={modal1.isOpen} onClose={modal1.onClose}>
        ...
        <ModalContent>
          ...
          <ModalBody w="80%" m="auto">
            <Button w="100%" border="1px solid gray" borderRadius="0px" bg="white" mt="20px"><Box w="15px" h="15px" mr="15px"><Image h="100%" w="100%"src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/53/Google_%22G%22_Logo.svg/800px-Google_%22G%22_Logo.svg.png" alt="google"/></Box>
            Continue with Google</Button>
          <Button w="100%" border="1px solid gray" borderRadius="0px" bg="white" mt="10px" mb="70px"><Box w="15px" h="15px" mr="15px"><Image h="100%" w="100%"src="https://cdn.icon-icons.com/icons2/936/PNG/512/apple-logo_icon-icons.com_73680.png" alt="google"/></Box>Continue with Apple</Button>
            {/* <Lorem count={2} /> */}
            <FormControl>
